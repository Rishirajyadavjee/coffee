...
if ($_POST) {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        if ($user['is_admin'] == 1) {
            redirect('admin.php'); // You can change this path
        } else {
    ...
    <div class="login-container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="Rishi" required>
            </div>

            <div class="form-group">
                <label for="password">Password</label>
                <input type="password" id="password" name="password" value="rishi123" required>
            </div>
